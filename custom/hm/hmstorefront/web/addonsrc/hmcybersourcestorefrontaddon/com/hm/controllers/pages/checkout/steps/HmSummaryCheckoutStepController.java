...
@Controller
@RequestMapping(value = "/checkout/multi/hm/summary")
public class HmSummaryCheckoutStepController extends AbstractCheckoutStepController
{
	private static final Logger LOGGER = Logger.getLogger(HmSummaryCheckoutStepController.class);

	private static final String SUMMARY = "summary";
	
	protected static final String REDIRECT_URL_SUMMARY = REDIRECT_PREFIX + "/checkout/multi/hm/summary/view";
	
	@Resource(name = "hmCheckoutFacade")
	private HmCheckoutFacade hmCheckoutFacade;
			...
			CommerceCartModificationException
	{
		...
		return HmcybersourcestorefrontaddonControllerConstants.Views.Pages.MultiStepCheckout.CheckoutSummaryPage;
	}
			...
			InvalidCartException, CommerceCartModificationException
	{
		...
		try
		{
			...
			isPaymentUthorized = hmCheckoutFacade.authorizePayment(placeOrderForm.getSecurityCode());
		}
