...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hmstorefront/electronics/en",
						"https://electronics.local:9002/hmstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hmstorefront/electronics/en",
						"https://electronics.local:9002/hmstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hmstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/hmstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hmstorefront/electronics/en",
						"https://electronics.local:9002/hmstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hmstorefront",
						"https://electronics.local:9002/hmstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hmstorefront",
						"https://electronics.local:9002/hmstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/hmstorefront/electronics/en",
						"https://electronics.local:9002/hmstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
