...
import com.hm.test.constants.HmTestConstants;
import com.hm.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HmTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/hmtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/hmtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/hmtest/import/cstickets.impex");
			...
			importImpexFile(context, "/hmtest/import/csquotes.impex");
		}
	}
}
