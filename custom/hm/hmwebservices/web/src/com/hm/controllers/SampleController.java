...
import com.hm.data.UserDataList;
import com.hm.dto.SampleWsDTO;
import com.hm.dto.TestMapWsDTO;
import com.hm.dto.UserWsDTO;
import com.hm.dto.UsersListWsDTO;
import com.hm.dto.UsersPageWsDTO;
import com.hm.facades.SampleFacades;
...
import static com.hm.constants.HmwebservicesConstants.SAMPLE_LIST_DOUBLE_VALUE;
import static com.hm.constants.HmwebservicesConstants.SAMPLE_LIST_STRING_VALUE;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/hmwebservices/sample/dto/sampleValue
	 *
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/hmwebservices/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/hmwebservices/sample/users
	 * <li>http://localhost:9001/hmwebservices/sample/users?fields=users(info)
	 * <li>http://localhost:9001/hmwebservices/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/hmwebservices/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/hmwebservices/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/hmwebservices/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/hmwebservices/sample/usersPaged
	 * <li>http://localhost:9001/hmwebservices/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/hmwebservices/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/hmwebservices/sample/users/user1
	 * <li>http://localhost:9001/hmwebservices/sample/users/user1?fields=info
	 * <li>http://localhost:9001/hmwebservices/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/hmwebservices/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/hmwebservices/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/hmwebservices/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 * <p>
	 * Url: http://localhost:9001/hmwebservices/sample/map
	 */
