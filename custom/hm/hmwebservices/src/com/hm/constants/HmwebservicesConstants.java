...
/**
 * Global class for all Hmwebservices constants. You can add global constants for your extension into this class.
 */
public final class HmwebservicesConstants extends GeneratedHmwebservicesConstants
{
	public static final String EXTENSIONNAME = "hmwebservices";
	...
	public static final String HOST = "hmwebservices.host";
	public static final String HOST_DEFAULT = "hostname";

	private HmwebservicesConstants()
	{
