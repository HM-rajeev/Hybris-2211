 ...
 */
package com.hm.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(HmFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HmFulfilmentProcessConstants.PARENT_PROCESS);
