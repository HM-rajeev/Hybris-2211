...
@Controller
@RequestMapping(value = "/checkout/multi/hm/payment-method")
public class HmPaymentMethodCheckoutStepController extends AbstractCheckoutStepController
{
	...
	private static final Logger LOGGER = Logger.getLogger(HmPaymentMethodCheckoutStepController.class);
	...
	public String enterStep(final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		else if (CheckoutPciOptionEnum.SOP.equals(subscriptionPciOption))
		{
			...
			try
			{
			   ...
			   //return ControllerConstants.Views.Pages.MultiStepCheckout.HmSilentOrderPostPage;				
	  			//return "addon:/hmcybersourcestorefrontaddon/pages/checkout/multi/hmsSilentOrderPostPage";  
	...
	protected HmPaymentFacade getHmPaymentFacade()
	{
		return hmPaymentFacade;
	}
}