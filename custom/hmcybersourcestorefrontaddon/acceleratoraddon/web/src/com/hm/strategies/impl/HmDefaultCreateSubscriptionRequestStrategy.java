...
public class HmDefaultCreateSubscriptionRequestStrategy implements HmCreateSubscriptionRequestStrategy
{
	private static final Logger LOG = Logger.getLogger(HmDefaultCreateSubscriptionRequestStrategy.class);
