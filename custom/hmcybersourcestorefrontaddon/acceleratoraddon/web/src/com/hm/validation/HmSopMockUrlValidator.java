 ...
 */
package com.hm.validation;

import de.hybris.platform.acceleratorservices.web.payment.validation.AbstractMockUrlValidator;
...
public class HmSopMockUrlValidator extends AbstractMockUrlValidator
{
	...
	protected static final String PAYMENT_RESPONSE_END_RELATIVE_URL = "/hmsop/hmresponse";	
	...
	private static final Logger LOG = LoggerFactory.getLogger(HmSopMockUrlValidator.class);
